...
#     filterlistscore = [col for col in dataframe if 'score' in col]

#     scoredataframe = dataframe[filterlistscore].copy()

#     scoremaxlist = scoredataframe.max()
#     scoreminlist = scoredataframe.min()
       
#     scoremax = scoremaxlist.max()
#     scoremin = scoreminlist.min()
        
#     denominator = scoremax - scoremin
       
#     filtercol_norm = ((dataframe[filterlistscore] - scoremin)/denominator)     

#     dataframe.update(filtercol_norm)
...
#         print(final_score_combination)
        ...
        return final_score_combination[scorecombsc].max(), final_rank_combination[rankcombsc].max()
...
def scorecombination(df,model,lmodel):
    ...
    return max(highestscorecombination), max(highestrankcombination)
...
for i in lmodels:
    sc, rc = scorecombination(df,'dfi',[i])  
    kk = 'dfi_' + i
    scoredict[kk] = sc
